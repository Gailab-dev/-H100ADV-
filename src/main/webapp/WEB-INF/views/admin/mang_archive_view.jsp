		...
		<div class="row">
			...
			<div class="button-wrapper">
				...
				<button id="btnUpdateArchive" type="button" class="btn btn-bule">
					수정</button>
				<button id="btnDeleteArchive" type="button" class="btn btn-bule">
					삭제</button>
				<button type="button" class="btn btn-secondary"
					onclick='location.href="/admin/mw_archive_list.do"'>목록</button>
			</div>
		</div>
			...
			function() {
				...
				$("#btnDeleteArchive").click(
						function() {
							...
							location.href="/admin/mw_archive_delete.do?id=${archive.a_id}";
						});
			})
	</script>
</body>
