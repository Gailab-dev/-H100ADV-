...
<body>
	...
	$("#example01").click(function() {
		...
		$('#move_up').click(function () {
		    ...
		    var tree = $('#tree').jstree(true);
		    var parentNode = tree.get_node(selectedNode.parent);
		    var index = parentNode.children.indexOf(selectedNode.id);

		    if (index > 0) { // 첫 번째 위치가 아니라면 이동 가능
		        var newIndex = index - 1;
		        parentNode.children.splice(index, 1); // 기존 위치 제거
		        parentNode.children.splice(newIndex, 0, selectedNode.id); // 새로운 위치 삽입
		        tree.refresh(); // 트리 업데이트
		    }
		});
	</script>
</body>
