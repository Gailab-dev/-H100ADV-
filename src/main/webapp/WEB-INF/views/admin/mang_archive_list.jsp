  ...
  <body>   
              ...
              <table class="table table-sm border-bottom">
                ...
                <tbody>
                  <c:forEach var="archive" items="${archiveList }">
                  	<tr>
	                  <td>${archive.a_id }</td>
	                  <th><a href="/admin/mw_archive_view.do?id=${archive.a_id }">${archive.a_title }</a></th>
	                  <td>${archive.u_name }</td>
	                  <td>${archive.date }</td>
	                  <td>${archive.a_count }</td>
	                </tr>
                  </c:forEach>
                </tbody>
              </table>
	...
	<script>
		function fn_prev(page, range, rangeSize, listSize, searchType, keyword) {
	        ...
	        var url = "/admin/mw_archive_list.do";
	        url += "?page=" + page;
	        url += "&range=" + range;
