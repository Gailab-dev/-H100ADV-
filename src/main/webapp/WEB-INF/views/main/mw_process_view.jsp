	...
	<div class="wrapper main-page">
		...
		<div class="container">
			...
			<form id="updateComplaint" method="post">
				...
				<table
					...
					<tbody>
						...
						<tr>
							<td colspan="2">${processComplaint.cWriteDate }</td>
						</tr>
						<tr>
						...
						<tr>
							<td><select name="cDepartment" id="cDepartment">
											<option>${processComplaint.cDepartment }</option>
											<option>없음</option>
			...
			<div class="button-wrapper">
				<button type="button" id="imsi" class="btn btn-bule"
					onclick="updateComplaint()">저장</button>
			</div>
						...
						<form id="insertSettleForm" method="post">
							<div class="d-flex">
								<input type="hidden" id="cId" name="cId"
									...
									type="hidden" name="viewName" value="mw_process_view" />
								...
								<c:choose>
									<c:when test="${sessionScope.userId == settle.uId }">
										<form id="settleUpdate${settle.csId }" name="settleUpdate">
											...
											<input type="hidden" name="viewName" value="mw_process_view" />
	...
	<div id="div6">
		...
		<form id="insertReplyForm" method="post">
			<input type="hidden" id="cId" name="cId"
				...
				id="psName" name="psName" value="#"> <input type="hidden"
	...
	<div id="div2" style="background: #f3f7fa; padding: 10px;">
		...
		<form id="updateProcessForm" method="post">
			<input type="hidden" id="cId" name="cId"
				...
				value="${processComplaint.cNotificated }"> <input
				type="hidden" name="viewName" value="mw_process_view" />
				...
				<tbody>
					<tr>
						...
						<td colspan="4" class="bg-white"><textarea name="cAnswer"
								id="cAnswer" wrap="on" rows="5" placeholder="조치내용(민원답변)">${processComplaint.cAnswer}</textarea>
						</td>
					</tr>
					...
					<tr>
						<td class="bg-white"><input type="date" id="cDeadline"
							name="cDeadline" value="${processComplaint.cDeadline }"
							max="9999-12-31"></td>

						<td class="bg-white"><select name="cComplete" id="cComplete">
								<option>${processComplaint.cComplete }</option>
								<option>통보완료</option>
								<option>통보미완료</option>
						</select></td>
						<!-- 
	                <td><input type="text" id="cSatisfiction" name="cSatisfiction" value="${processComplaint.cSatisfiction }"></td>
	                 -->
						<td class="bg-white"><select name="cSatisfiction"
							id="cSatisfiction">
								<option>${processComplaint.cSatisfiction }</option>
								<option>매우만족</option>
								<option>만족</option>
								<option>보통</option>
								<option>불만</option>
		...
		<button type="button" class="btn btn-secondary" id="imsi" name="imsi">임시
		 ...
		 -->
			...
			<button type="button" class="btn btn-bule" id="complete"
				name="complete" onclick="complaintComplete()">저장</button>
		</div>
	</div>
	</div>
	</div>
