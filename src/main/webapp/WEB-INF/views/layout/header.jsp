<%--260724_서희원_레이아웃 구조 변경으로 임시 주석처리 중입니다.--%>

<%--<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>--%>
<%--<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>--%>
<%--&lt;%&ndash; 공용 헤더 (Tiles defaultLayout). deviceList 하드코딩 헤더를 공유 레이아웃으로 이관--%>
<%--     (요청 2026-07-16) 내 정보 진입점을 left 사이드바 → 헤더(사용자명 왼쪽 사람아이콘)로 이동, 클릭 시 모달로 표시 &ndash;%&gt;--%>
<%--<style>--%>
...
<%--		</c:if>--%>
<%--		&lt;%&ndash; (15번 4-2) 알림 벨. 30초 폴링으로 안읽은 개수를 배지에 표시하고, 클릭 시 최근 10건 팝업 &ndash;%&gt;--%>
<%--		<div class="noti-wrap">--%>
...
<%--		&lt;%&ndash; 내 정보 버튼(사용자명 왼쪽). 아이콘은 기존 left 사이드바의 '내 정보' 아이콘 그대로 &ndash;%&gt;--%>
...
<%--&lt;%&ndash; 내 정보 모달: iframe 으로 /myInfo/modal(공용 chrome 없는 문서) 로드 → 호출 화면과 CSS/JS 완전 분리 &ndash;%&gt;--%>
