...
<aside class="sidebar">
	<ul class="menu">
		<%-- 대시보드 (신설) --%>
		<li><a class="${fn:contains(uri, '/dashboard') ? 'active' : ''}" href="${cp}/dashboard">
		...
		<%-- 불법주차 리스트 --%>
		<li><a class="${fn:contains(uri, '/eventList') ? 'active' : ''}" href="${cp}/eventList/viewEventList.do">
			<svg class="menu-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<%-- 통계 --%>
		<li><a class="${fn:contains(uri, '/stats') ? 'active' : ''}" href="${cp}/stats/viewStat.do">
			<svg class="menu-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<%-- 디바이스 리스트 --%>
		<li><a class="${fn:contains(uri, '/deviceList') ? 'active' : ''}" href="${cp}/deviceList/viewDeviceList.do">
			<svg class="menu-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<%-- SIP CALL (신설) --%>
		<li><a class="${fn:contains(uri, '/sipcall') ? 'active' : ''}" href="${cp}/sipcall/sipCallLog">
			<svg class="menu-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<%-- 내 정보 --%>
		<li><a class="${fn:contains(uri, '/myInfo') ? 'active' : ''}" href="${cp}/myInfo/viewMyInfo.do">
			<svg class="menu-icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
