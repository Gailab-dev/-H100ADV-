          ...
          <div class="container">
            ...
            <div class="serch-form row border pt-2 bg-light mx-1">
              <div class="col-md-2 pb-2">
                ...
                >
                  ...
                  <option value="dpName">부서</option>
                  <option value="ilIp">IP</option>
                </select>
              </div>
            ...
            <div class="table-responsive mt-4">
              <table class="table table-sm border-bottom">
                ...
                <tbody>
                  <c:forEach var="ipLog" items="${ipLogList }">
                  	<tr>
	                  <td>${ipLog.ilId }</td>
	                  <th>${ipLog.dpName }</th>
	                  <td>${ipLog.uName }</td>
	                  <td>${ipLog.ilLoginTime }</td>
	                  <td>${ipLog.ilIp }</td>
	                </tr>
                  </c:forEach>
                </tbody>
