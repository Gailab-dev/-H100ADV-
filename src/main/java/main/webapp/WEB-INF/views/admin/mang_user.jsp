  ...
  <body>   
	...
	<div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div id="user_info" class="alert alert-secondary d-flex align-items-center" role="alert">
            사용자를 선택해주세요.
          </div>
            ...
            <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
              <div class=" order-md-1">
                  <div class="mb-3">
                    ...
                    <input type="name" class="form-control" id="name" placeholder="이름을 입력해 주세요." disabled>
                  </div>
                  <div class="mb-3">
                    <label for="id">아이디<span class="text-muted"></span></label>
                    <input type="id" class="form-control" id="id" placeholder="아이디를 입력해 주세요." disabled>
                  </div>
                  <div class="mb-3">
                    <label for="id">패스워드<span class="text-muted"></span></label>
                    <input type="password" class="form-control" id="password" placeholder="8자리 이상 입력해주세요.">
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <label for="u_admin_num">행정번호 뒷번호 4자리</span></label>
                    <input type="email" class="form-control" id="u_admin_num" placeholder="행정번호 4자리를 입력해주세요.">
                  </div>
                  <div class="mb-3">
                    <label for="grade">접근 등급</span></label>
                  ...
                  <div class="row">
                    <div class="col-md-5 mb-3">
                      ...
                      <select id="sele_part" class="form-control">
					  </select>
                    </div>
                    <div class="col-md-4 mb-3">
                      <label for="state">직급</label>
                      <select id="sele_position" class="form-control">
					  </select>
                    </div>
                  </div>
                  <hr class="mb-4">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <button class="btn btn-success btn-block" type="submit" id="save">사용자 수정</button>
                  </div>
                  <div class="col-md-6 mb-3">
                    <button class="btn btn-outline-danger btn-block" type="submit" id="delete">사용자 삭제</button>
                  </div>
                  <div class="col-md-6 mb-3">
                    <button class="btn btn-success btn-block" type="submit" id="excel" onclick="location.href='/deptUserList.do'">엑셀 출력</button>
                  </div>
                </div>
              </div>
            </div>
