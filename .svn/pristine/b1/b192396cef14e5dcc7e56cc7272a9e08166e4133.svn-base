				...
				<form id="insertForm" method="post">
					...
					<tbody>
						<tr>
							...
							<th class="bg-light"><span style="color: red;">*</span> 분류
								유형</th>
							...
							<th class="bg-light"><span style="color: red;">*</span> 처리
								구분</th>
						...
						<tr>
							<td><input name="cReceiptDate" id="cReceiptDate" type="date"
								max="9999-12-31"></td>
							...
							<td><input name="cRaiseCount" id="cRaiseCount" type="number"
								min="0" value="0"></td>
							<td><input name="cRaiseDate" id="cRaiseDate" type="date"
								max="9999-12-31"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input name="cOfficer01" id="cOfficer01"
								placeholder="과장명 입력"></td>
							<td><input name="cOfficer02" id="cOfficer02"
								placeholder="계장명 입력"></td>
							<td><input name="cOfficer03" id="cOfficer03"
								placeholder="담당자명 입력"></td>
						</tr>
						<tr>
							<th class="point" rowspan="2">연관부서(팀)</th>
							<th class="bg-light">연관부서(팀)1</th>
							<th class="bg-light">연관부서(팀)2</th>
							<th class="bg-light">연관부서(팀)3</th>
							<th class="bg-light">연관부서(팀)4</th>
						</tr>
						<tr>
			...
			<table
				...
				<form id="insertForm" method="post">
					...
					<tbody>
						...
						<tr>
							<th class="border-blue point" colspan="2"><span
								style="color: red;">*</span> 제목</th>
						</tr>
						<tr>
						...
						<tr>
							<th class="point" colspan="2"><span style="color: red;">*</span>
								위치</th>
						</tr>
						<tr>
						...
						<tr>
							<th class="point" colspan="2">연관부서(팀)</th>
						</tr>
						<tr>
							<th class="bg-light">연관부서(팀)1</th>
							<th class="bg-light">연관부서(팀)2</th>
				...
				<div style="color: red">* 본 화면은 기본사항 등록을 위한 화면으로서, 임시저장 목록에서
					해당건의 추가적인 사항을 입력한 후 "등록확정"(하단)을 클릭하여야 정상 등록됩니다.</div>
			</table>
			<div class="button-wrapper">
				<button type="button" class="btn btn-bule" id="imsi">임시 저장</button>
				<!-- 
				<button type="button" class="btn btn-bule" id="register" onclick="register()">등록 확정</button>
				 -->
